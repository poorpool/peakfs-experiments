...
export PEAKFS_ROOT=/home/yhm/peakfs
export LD_LIBRARY_PATH=/usr/local/lib64:/usr/local/lib:${PEAKFS_ROOT}/install:${LD_LIBRARY_PATH}
export LD_LIBRARY_PATH=/usr/mpi/gcc/openmpi-4.1.5rc2/bin:${LD_LIBRARY_PATH}
export PATH=/usr/mpi/gcc/openmpi-4.1.5rc2/bin:$PATH
export PEAKFS_CFG_PATH=${PEAKFS_ROOT}/cfg/cfg-cyx.json
export PEAKFS_VIEW_PATH=${PEAKFS_ROOT}/cfg/view.json
export PEAKFS_PRELOAD=${PEAKFS_ROOT}/install/libpeakfs_preload.so

export LD_LIBRARY_PATH=/home/yhm/spdk_root/lib:${LD_LIBRARY_PATH}
export LD_LIBRARY_PATH=/home/yhm/spdk_root/usr/local/lib:/home/yhm/spdk_root/usr/local/lib64:${LD_LIBRARY_PATH}
...
--allow-run-as-root \
  ...
  --bind-to numa:overload-allowed \
  --hostfile hostfile \
  -x PEAKFS_CFG_PATH=${PEAKFS_CFG_PATH} \
  -x PEAKFS_VIEW_PATH=${PEAKFS_VIEW_PATH} \
  -x PEAKFS_HOOK_FILTER=io500 \
  -x LD_PRELOAD=${PEAKFS_PRELOAD} \
